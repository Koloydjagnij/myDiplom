...
namespace test.Migrations
{
    ...
    [Migration("20190513210708_test2")]
    partial class test2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("test.ApplicationToSpeciality", b =>
                {
                    ...
                    b.HasIndex("IdApplicationToSpeciality");
            ...
            modelBuilder.Entity("test.Enrollee", b =>
                {
                    ...
                    b.Property<string>("NumOfPersonalFile")
                    ...
                    b.HasIndex("DateOfDeduction");

                    b.HasIndex("GradePointAVG");
                    ...
                    b.HasIndex("NumOfPersonalFile");

                    b.HasIndex("Surname");

                    b.HasIndex("YearOfEndingEducation");
            ...
            modelBuilder.Entity("test.EnrolleeAchievement", b =>
                {
                    ...
                    b.HasIndex("IdEnrolleeAchievement");
            ...
            modelBuilder.Entity("test.ExamForSpeciality", b =>
                {
                    ...
                    b.HasIndex("IdExamForSpeciality");
            ...
            modelBuilder.Entity("test.Models.ChangeHistory", b =>
                {
                    ...
                    b.Property<int?>("EnrolleeIdEnrollee");
                    ...
                    b.HasIndex("EnrolleeIdEnrollee");

                    b.ToTable("change_history");
                });

            modelBuilder.Entity("test.Models.DocumentFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("test.Models.ChangeHistory", b =>
                {
                    b.HasOne("test.Enrollee")
                        .WithMany("ChangeHistory")
                        .HasForeignKey("EnrolleeIdEnrollee");
                });
